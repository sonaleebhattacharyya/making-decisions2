...
/*
  ...
  console log a 'B', between 70 and 79, 'C', between 60 and 69, 'D', and anything 
  below 60 should console log an 'F'.
*/
...
// If it's less than 7, log 'There are not enough elements in this array' to the 
//console. If the length is more than 7, reassign the value of 'someNum' to the value 
//of the 7th element in the array. (Hint: how can you make sure that your code works fo
...
// each number is divisible by 3. If it is, console.log '{number} is divisible by 3.'
...
// Look up switch statements (I recommend W3 Schools) and try 
// to implement one for the following.
...
/* The famous FizzBuzz, Devmountain style!
  ...
  if the number your for loop is currently on is divisible by 3, 
  console.log 'Dev'. If the number is divisible by 5, console.log 'mountain'. 
  If the number is divisible by 5 & 3, console.log 'Devmountain'. If the number is 
  not divisible by 5 or 3, console.log the number itself. Hint: Look up the modulo 
  operator.
